...
var operators, evaluators,
    ...
    UnimplementedOperatorError, IncompatibleArgumentsError;
...
function isNumeric(a) {
  ...
  return isLiteral(a) && !!numericTypes[literalType(a)];
}
...
operators = {
  ...
  'exists': function (a) { throw new UnimplementedOperatorError('EXISTS'); },
  'not exists': function (a) { throw new UnimplementedOperatorError('NOT EXISTS'); },
  'sameterm': function (a, b) {
    if (N3Util.isBlank(a) || N3Util.isBlank(b))
      return false;
    return a === b;
  },
  'in': function () { throw new UnimplementedOperatorError('IN'); },
  'not in': function () { throw new UnimplementedOperatorError('NOT IN'); },
  ...
  'uri': this.iri,
  'bnode': function (a) { throw new UnimplementedOperatorError('BNODE'); },
  ...
  'round': function (term) { return Math.abs(term); },
  ...
  'md5': function (arg) { return new crypto.MD5(arg); },
  'sha1': function (arg) { return new crypto.SHA1(arg); },
  'sha256': function (arg) { return new crypto.SHA256(arg); },
  'sha384': function (arg) { return new crypto.SHASHA3(arg); },
  'sha512': function (arg) { return new crypto.SHA512(arg); },
...
UnimplementedOperatorError = createErrorType('UnimplementedOperatorError', function (operatorName) {
  this.message = 'Unsupported operator: ' + operatorName + 'not yet implemented.';
});
