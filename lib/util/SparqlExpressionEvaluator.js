...
function SparqlExpressionEvaluator(expression) {
  ...
  if (!evaluator)
    throw new UnsupportedExpressionError(expression, expressionType);
...
evaluators = {
  ...
  operation: function (expression) {
    ...
    if (!operator)
      throw new UnsupportedOperatorError(expression, operatorName);
...
UnsupportedExpressionError = createErrorType('UnsupportedExpressionError', ExpressionError,
function (expression, type) {
  this.super(expression, 'Unsupported expression type: ' + type + '.');
});

UnsupportedOperatorError = createErrorType('UnsupportedExpressionError', ExpressionError,
function (expression, operator) {
  this.super(expression, 'Unsupported operator: ' + operator.toUpperCase() + '.');
});
