    ...
    // Evaluate a variable to its value
      ...
      return function (bindings) {
        if (!bindings || !(expression in bindings))
          throw new UnboundVariableError(expression);
...
var UnboundVariableError = createErrorType('UnboundVariableError', function (variableName) {
  this.message = 'Cannot evaluate variable ' + variableName + ' because it is not bound.';
});
...
module.exports.UnboundVariableError = UnboundVariableError;
