...
util.hasVariables = function (pattern) {
  return !!pattern && (util.isVariable(pattern.subject) ||
                       ...
                       (!!pattern.context && util.isVariable(pattern.context)));
};
...
util.getVariables = function (pattern) {
  ...
  if (pattern.context && util.isVariable(pattern.context)) variables.push(pattern.context);
  return variables;
};
...
util.hasVariablesOrBlanks = function (pattern) {
  return !!pattern && (util.isVariableOrBlank(pattern.subject) ||
                       ...
                       (!!pattern.context && util.isVariableOrBlank(pattern.context)));
};
...
util.applyBindings = function (bindings, pattern) {
  ...
  if (bindings[pattern.context] || pattern.context) {
    newBindings.context = bindings[pattern.context] || pattern.context;
  }
  return newBindings;
};
...
util.extendBindings = function (bindings, triplePattern, boundTriple) {
  ...
  triplePattern.context && util.addBinding(newBindings, triplePattern.context,   boundTriple.context);
  return newBindings;
};
