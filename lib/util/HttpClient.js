 ...
 */
HttpClient.prototype.get = function (url, headers, followRedirect) {
  return this.request(url, 'GET', headers, followRedirect);
};
 ...
 * @returns {Iterator} An iterator of the representation
 */
HttpClient.prototype.request = function (url, method, headers, followRedirect) {
