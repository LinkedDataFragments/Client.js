...
function HttpClient(options) {
  ...
  this._ssl =  _.mapValues(options.ssl || {}, function (sslConfig) {
    return _.mapValues(sslConfig || {}, readHttpsOption);
  });
...
HttpClient.prototype.request = function (url, method, headers, options) {
  var startUrl = url.indexOf('?') === -1 ? url : url.substring(0, url.indexOf('?'));
