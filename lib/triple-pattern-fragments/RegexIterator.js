...
// TODO: not completely sure about the safety of this
// create a RegexIterator based on the settings of this one, but with a new source
RegexIterator.prototype.copy = function (newSource) {
  if (!this._fragment)
    this._fragment = this._client.getFragmentByPattern({substring: this._regex});

  var result = new RegexIterator(newSource, this._regexFilter, this._options);
