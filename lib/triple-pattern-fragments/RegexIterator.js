...
// TODO: a regex is applied to a variable, something we can do with that?
function RegexIterator(parent, regexFilter, options) {
  ...
  this._regex = regexFilter.args[1].substring(1, regexFilter.args.length - 2); // change '"regex"' to 'regex'
