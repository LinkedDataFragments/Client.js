...
function CompoundFragment(fragments, options) {
  ...
  var fragmentCount = fragments.length, errorCount = 0,
      pendingFragments = this._pendingFragments = _.indexBy(fragments, getIndex),
      combinedMetadata = this._metadata = { totalTriples: 0 },
      pendingFragmentsCount = fragmentCount,
      pendingMetadataCount  = fragmentCount;
