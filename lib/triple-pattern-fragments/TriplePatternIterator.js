...
TriplePatternIterator.prototype._readTransformer = function (fragment, fragmentBindings) {
  ...
  while (triple = fragment.read()) {
    ...
    // This dummy triple is emitted by TurtleFragmentIterator at the end of the fragment,
    // because without it, one of the iterators in the chain stops reading.
    // The dummy triple does not have any meaning and should be ignored.
    if (triple.subject === '<fragment-end>') break;
