...
LinkedDataFragmentsClient.prototype = {
  ...
  _getPatternOptions: function (pattern) {
    ...
    return optionsPerSubPattern.then(function (optionsPerSubPattern) {
      ...
      // if one of the subpatterns has no valid options, there are no results
      ...
      // if no binding remains, "null" signals that no option must be chosen
      return optionsPerSubPattern[0] || null;
    });
  },
