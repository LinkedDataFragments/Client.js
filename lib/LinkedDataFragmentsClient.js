  ...
  _getSubPatternBindings: function (subPattern) {
    ...
    return fragments.then(function (fragments) {
      ...
      if (_.contains(tripleCounts, 0)) {
        return subPattern.reduce(function (bindings, triple) {
          return getVariables(triple.unbound).forEach(function (variable) {
      ...
      if (_.max(tripleCounts) === 1) {
        return subPattern.reduce(function (bindings, triple) {
          return addBindings(bindings, triple.unbound, triple);
        }, {});
      }
