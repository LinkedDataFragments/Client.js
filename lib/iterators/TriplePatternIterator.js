...
TriplePatternIterator.prototype._read = function () {
  ...
  if (!fragment) {
    ...
    } while (bindings && fragments.length < this._maxBufferSize);
...
TriplePatternIterator.prototype._addFragment = function (bindings) {
  ...
  fragment.on('readable', function () { self._fillBuffer(); });
  fragment.on('end',      function () { self._fillBuffer(); });
};

// Flushes remaining data after the source has ended
TriplePatternIterator.prototype._flush = function () {
