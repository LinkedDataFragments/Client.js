...
function Iterator(options) {
  ...
  this.on('newListener', function waitForDataListener(event) {
    if (event === 'data') {
      var self = this;
      this.on('readable', function readAll() {
...
Iterator.prototype._fillBuffer = function () {
  ...
  if (this.ended) {
    ...
    (function removeListeners(self) {
      ...
      self.addListener('newListener', removeListeners.bind(self, self));
    })(this);
  }
};
...
Iterator.prototype._fillBufferAsync = function () {
  ...
  if (!this._fillBufferPending && (this._hasBufferSpace() || this.ended)) {
...
Iterator.prototype._bufferAll = function () {
  ...
  this._fillBufferAsync();
  this.on('readable', this._fillBufferAsync.bind(this));
};
