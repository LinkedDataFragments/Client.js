...
var Iterator = require('./Iterator'),
    BindingsIterator = require('./BindingsIterator'),
...
BindingsIterator.inherits(GraphPatternIterator);

// Creates a pipeline with triples matching the binding of the iterator's graph pattern
GraphPatternIterator.prototype._createBindingsTransformer = function (bindings, options) {
