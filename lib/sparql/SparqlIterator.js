...
var InvalidQueryError = createErrorType('InvalidQueryError', Error, function (query, cause) {
  this.message = 'Syntax error in query\n' + cause.message;
});

// Error thrown when no combination of iterators can solve the query
var UnsupportedQueryError = createErrorType('UnsupportedQueryError', Error, function (query, cause) {
