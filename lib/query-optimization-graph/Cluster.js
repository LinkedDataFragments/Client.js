...
Cluster.prototype.supply = function (callback) {
  var self = this;
  var suppliers = this.suppliers(); // TODO: is supplyPath really necessary?
  if (_.isEmpty(suppliers)) {
...
Cluster.prototype.update = function (updatedNode, callback) {
  ...
  if (ClusteringUtil.containsObject(_.pluck(this.supplyPath(this.suppliers()), 'pattern'), updatedNode.pattern)) {
