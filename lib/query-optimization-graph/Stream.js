...
BindingStream.prototype.feed = function (bindings) {
  ...
  this.logger.info("FEED results: " + this.results.length + ", streams: " + this._streams.length + ", bindings: " + this._bindings.length + ", triples: " + this.tripleCount);
};
