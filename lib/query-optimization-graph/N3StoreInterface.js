...
N3StoreInterface.prototype.matchBindings = function (nodes, callback, v) {
  ...
  var orderedNodes = [];
  var uniques = [];
  var cachedBindings = bestCache.bindings;
...
//    bindings = uniq;
  ...
  if (v) {
    ...
    if (cachedBindings && cachedBindings === bestCache.bindings && cachedBindings.length > 0 && cachedBindings[0].bindings)
      uniques = this.uniq(cachedBindings, v);
    bindings = uniques;
  } else {
...
var DEBUGTIMER = {pre:0, find:0, newTriples:0, updatedTriples:0, filter:0, basic:0, rest:0, extend:0, extend_triples:0, extend_tree:0, extend_merge:0, bestCache:0, uniq:0, block:0, total:0};
