...
//var store = new NeDBStoreInterface();
//store.addTriples([
//  rdf.triple('a', 'b', 'c'),
//  rdf.triple('c', 'b', 'd'),
//  rdf.triple('c', 'e', 'a'),
...
//], function () {
//  console.log('ADDED');
//  store.matchBindings([rdf.triple('?s1', 'b', '?o1'), rdf.triple('?o1', 'e', '?o2')], function (bindings) {
//    console.log('MATCHED');
...
//var store = new NeDBStoreInterface();
//store.addTriples(_.map(_.range(100000), function (i) { return rdf.triple(i + "", i+1 + "", i+2 + ""); }), function () {
//  console.time('QUERY');
//  store.matchBindings([rdf.triple('?s', '?p', '?o')], function (bindings) {
//    console.timeEnd('QUERY');
//    console.log(_.size(bindings));
//  });
//});
