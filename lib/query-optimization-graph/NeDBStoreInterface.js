...
//      var bindingMatches = [];
//      var tripleMatches = [];
//      matchVal = binding[sortVar];
//      while (bindingIdx < _.size(bindings) && bindings[bindingIdx][sortVar] === matchVal) {
//        bindingMatches.push(bindings[bindingIdx]);
//        ++bindingIdx;
//      }
//      while (tripleIdx < _.size(triples) && triples[tripleIdx][sortPos] === matchVal) {
//        tripleMatches.push(triples[tripleIdx]);
//        ++tripleIdx;
//      }
//      _.each(bindingMatches, function (binding) {
//        _.each(tripleMatches, function (triple) {
//          var valid = _.every(patternVarPos, function (varPos) { return !_.has(binding, varPos.v) || binding[varPos.v] === triple[varPos.p]; } );
//          if (valid) {
//            var result = _.clone(binding);
//            _.each(patternVarPos, function (varPos) { result[varPos.v] = triple[varPos.p]; });
