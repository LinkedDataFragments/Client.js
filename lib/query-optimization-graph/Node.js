...
Node.prototype.update = function (v, count, vals, added, removed, remaining, callback, certainty) { // TODO: parameter ordering
  ...
  if (bindStream) {
    ...
    bindStream.stabilize(function () {
      bindStream.updateRemaining(remaining, certainty);
      callback();
    });
  } else {
    callback();
