...
Node.prototype.update = function (v, count, remaining, vals, bounds, estimate, completeBindings, added, removed, complete, updatedNode, callback) {
...
//  }
  ...
  if (bindStream === this.activeStream) {
    ...
    if (ClusteringUtil.containsObject(_.pluck(nodes, 'pattern'), updatedNode.pattern)) {
...
Node.prototype.read = function (callback) {
  ...
  this.activeStream.read(function (buffer, remove) {
    ...
    self.newTriples = buffer.concat(self.adds);
