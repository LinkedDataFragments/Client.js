...
Node.prototype.updateDependency = function () {
  ...
  var v = this.activeStream.bindVar;
  ...
  // TODO: remove nodes that have no path to the suppliers of bindVar
...
//  }
  ...
  if (bindStream && (bindStream === this.activeStream)) {
    this.DEBUGclusters[v].matchSuppliers(self.dependencies, function (specificBindings, ownEstimate, ownMatchRates, ownEstimates) {
