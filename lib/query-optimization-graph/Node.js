...
//  //console.timeEnd("UPDATE BOUNDS");
  ...
  if (minStream !== this.activeStream && minStream !== this.fullStream && !this.supplies(minStream.bindVar)) {
  ...
  // TODO: temporary hack, might work, might go horribly wrong if we don't find matches for a long time, also, should remove these values once we actually get bindings
//  if (_.isEmpty(completeBindings))
//    completeBindings = added;
